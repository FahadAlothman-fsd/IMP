...
class PrayTimes:
    ...
    def tune(self, timeOffsets):
        self.offsets.update(timeOffsets)  # type: ignore
...
if __name__ == "__main__":
    ...
    print("Prayer Times for today in Riyadh/Saudi Arabia\n" + ("=" * 41))
    print("Method: " + prayTimes.getMethod())
    print("Latitude: " + str(24.7136))
    print("Longitude: " + str(46.6753))
    print("Timezone: " + str(3))
    print("Date: " + str(date.today()) + "\n" + ("=" * 41))
    times = prayTimes.getTimes(date.today(), (24.7136, 46.6753), +3, 0, "12h")
    for i in ["Fajr", "Sunrise", "Dhuhr", "Asr", "Maghrib", "Isha"]:
        print(i + ": " + times[i.lower()])  # type: ignore
